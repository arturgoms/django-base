...
class PartialViewSetMixin:
    ...
    def _get_field_resolvers(self, field):
        ...
        """
        nested_re = re.compile(r'{field}_(.+)_{suffix}'.format(
            field=field, suffix=self.resolver_suffix))
...
class CreateModelMixin:
    ...
    def create(self, request, *args, **kwargs):
        serializer = self.get_serializer(data=request.data, serializer_class=self.create_serializer_class)
...
class ListModelMixin:
    ...
    def list(self, request, *args, **kwargs):
        ...
        if page is not None:
            serializer = self.get_serializer(page, many=True, serializer_class=self.list_response_serializer_class)
            return self.get_paginated_response(serializer.data)

        serializer = self.get_serializer(queryset, many=True, serializer_class=self.list_response_serializer_class)
...
class RetrieveModelMixin:
    ...
    def retrieve(self, request, *args, **kwargs):
        ...
        serializer = self.get_serializer(instance, serializer_class=self.retrieve_response_serializer_class)
        return Response(serializer.data)
...
class UpdateModelMixin:
    ...
    def update(self, request, *args, **kwargs):
        ...
        serializer = self.get_serializer(instance=instance, serializer_class=self.update_response_serializer_class)
        return Response(serializer.data)
