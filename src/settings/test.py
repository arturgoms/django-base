...
DATABASES['default']['TEST'] = {
    'NAME': config('DATABASE_TEST_NAME', '_test')
}
...
DYNAMIC_CONFIG_BACKEND = 'apps.crosscutting.dynamic_config.backends.dummy.DummyDynamicConfigBackend'
...
NOTIFICATION_BACKEND = "apps.websocket.notification.backend.dummy.DummyNotificationBackend"
